...
import {persistMovieMentorLegacyMigrationChallenge,readMovieMentorLegacyMigrationChallenge,consumeMovieMentorLegacyMigrationChallenge,readMovieMentorLegacyMigrationConsumption,bindMovieMentorLegacyMigrationConsumptionIssuance} from "./MovieMentorLegacyMigrationChallengeStore.js";
...
function createMovieMentorLegacyMigrationCeremony({
  ...
  const issuer=createMovieMentorLegacyMigrationAttestationIssuer({now,randomId,issuer:expectedIssuer,readConsumption,bindConsumptionIssuance,createIssuance,readIssuanceByConsumptionId});
