...
function checkoutStatus(){return Object.freeze({version:VERSION,domain:AUTHORITY_DOMAIN,production:true,durableCheckoutBinding:true,checkoutBindingResolution:true,serverOwnedIdempotency:true,purchaseIntentProvenanceRequired:true,explicitProviderRequired:true,processLocalFallback:false});}
function createMovieMentorProductionCommercialCheckoutComposition({purchaseIntentAuthority,providers={}}={}){
 ...
 const authority=Object.freeze({initiateCheckout:rawAuthority.initiateCheckout,resolveCheckoutBinding,getStatus:checkoutStatus});
...
function getMovieMentorProductionCommercialCheckoutCompositionStatus(){const store=getMovieMentorCommercialCheckoutBindingMongoStoreStatus();return Object.freeze({version:VERSION,providerNeutral:true,publicRoute:false,providerIngress:false,implicitProvider:false,durableCheckoutBinding:true,checkoutBindingResolution:true,configured:store.configured,authorityCapability:checkoutStatus()});}
