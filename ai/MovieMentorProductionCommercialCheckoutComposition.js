...
function checkoutStatus(){return Object.freeze({version:VERSION,domain:AUTHORITY_DOMAIN,production:true,durableCheckoutBinding:true,checkoutBindingResolution:true,providerPaymentReferenceBinding:true,providerPaymentReferenceResolution:true,serverOwnedIdempotency:true,purchaseIntentProvenanceRequired:true,explicitProviderRequired:true,processLocalFallback:false});}
function createMovieMentorProductionCommercialCheckoutComposition({purchaseIntentAuthority,providers={}}={}){
 ...
 const authority=Object.freeze({initiateCheckout:rawAuthority.initiateCheckout,resolveCheckoutBinding,bindProviderPaymentReference,resolveCheckoutBindingByProviderPaymentReference,getStatus:checkoutStatus});
