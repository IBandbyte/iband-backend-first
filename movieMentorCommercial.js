...
function createMovieMentorCommercialRouter({requestAuthority,purchaseIntentAuthority,checkoutAuthority}={}){
  ...
  router.get("/health",(_req,res)=>res.json({success:true,service:"movie-mentor-commercial-gateway",version:VERSION,authority:{authenticatedPrincipalRequired:true,clientCannotChoosePrincipal:true,clientCannotChoosePrice:true,clientCannotChooseUnits:true,durablePurchaseIntentRequired:true,checkoutRequiresOwnedIntent:true}}));
