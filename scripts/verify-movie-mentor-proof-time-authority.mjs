...
const closureStore={readExecution:async()=>({schema:6,phase:"active",executionId:"e",ownerId:"o",leaseGeneration:1,leaseReference:"l",fencingToken:"f",leaseExpiresAt:"2032-01-01T00:10:00.000Z",providerCalls:[],providerCallsClaimed:0}),beginClosing:async()=>null,recoverExpiredIntoClosing:async()=>null,completeClosing:async()=>null,quarantineExecution:async()=>null};
...
const canonicalStore=createMovieMentorCanonicalResultMongoStore({mongoModel:canonicalModel,executionCollection:false,readIndexes:async()=>physicalIndexes});
