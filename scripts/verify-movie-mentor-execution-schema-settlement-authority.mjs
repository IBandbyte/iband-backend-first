...
async function settlementReasonFor(executionSchema){
  const execution={
    domain:"iband.movie-mentor.inference-execution-store",schema:executionSchema,phase:"finalized",
    executionId:`execution-schema-${executionSchema}`,creatorTurnId:`turn-execution-schema-${executionSchema}`,
    ...
    requestDigest:"request-execution-schema",closureReference:"closure-execution-schema",closureCertificateDigest:"closure-execution-schema-digest",
    finalizedResultReference:"result-execution-schema",finalizedCandidateReference:"candidate-execution-schema",
    finalizedResultDigest:"result-digest-execution-schema",resultFinalizedAt:new Date("2032-01-01T00:00:00.000Z"),
  };
