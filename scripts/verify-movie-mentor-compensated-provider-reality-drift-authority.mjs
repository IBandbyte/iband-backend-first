...
const effect={providerCallId:"call-307",executionId:"execution-307",slotId:"semantic",task:"movie-mentor-semantic",state:"confirmed",revision:1,evidence:[{externalEffectId:"effect-A",provider:"test",observedAt:"2035-01-01T00:00:01.000Z",source:"provider-ack"}]};
