...
const physicalRows={
  ...
  movie_mentor_inference_entitlement:{domain:"iband.movie-mentor.inference-spend",schema:1,principalId:execution.principalId,status:"active",remainingUnits:4,reservedUnits:1,consumedUnits:0,entitlementRevision:3},
};
