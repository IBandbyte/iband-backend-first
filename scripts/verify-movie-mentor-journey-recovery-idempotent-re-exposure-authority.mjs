...
async function run({revokeAfterIdempotentResolution=false}={}){
 ...
 const publicationBoundary={async publish(){idempotentResolved=true;return{recoveryStatus:"idempotent",projectId:"project-1",principalId:"creator-1",ownershipRef:"ownership-A",recoveryRevision:7,recoveryGeneration:7,recoveryReference:"recovery-7",recoveryFingerprint:"recovery-fp-7",lineageId:"lineage-1",authorityGeneration:11,progressionRevision:19,envelopeFingerprint:"fingerprint-existing-checkpoint",capturedAt:"2026-09-05T23:00:00.000Z"};}};
