...
const store={async readExecution(){return structuredClone(execution);},async beginClosing(){throw new Error("unused");},async recoverExpiredIntoClosing(){throw new Error("unused");},async completeClosing(){throw new Error("unused");},async quarantineExecution(){throw new Error("superseded policy must fail before reality/quarantine authority");}};
const authority=createMovieMentorInferenceExecutionClosureAuthority({store,effectStore:{async readEffect(){return null;}}});
