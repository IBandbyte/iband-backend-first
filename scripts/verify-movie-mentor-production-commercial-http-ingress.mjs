...
assert.match(source,/status\?\.domain===INGRESS_DOMAIN/);assert.match(source,/purchaseIntentProvenanceRequired===true/);assert.match(source,/issuanceProvenanceRequired===true/);assert.match(source,/processLocalFallback===false/);
