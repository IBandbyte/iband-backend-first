...
async function settlementReasonFor(resultSchema){
  ...
  const execution={domain:"iband.movie-mentor.inference-execution-store",schema:6,phase:"finalized",executionId:`execution-result-schema-${resultSchema}`,creatorTurnId:`turn-result-schema-${resultSchema}`,principalId:"creator-schema",projectId:"project-schema",reservationId:`reservation-result-schema-${resultSchema}`,requestDigest:"request-schema",leaseGeneration:7,leaseReference:"lease-canonical-schema",fencingToken:"fence-canonical-schema",closureReference:"closure-schema",closureCertificateDigest:"closure-digest-schema",closurePolicyVersion:"5A.24-round-four-v6",finalizedResultReference:"deliberately-wrong-result-reference",finalizedCandidateReference:`candidate-result-schema-${resultSchema}`,finalizedResultDigest:resultDigest,resultFinalizedAt:new Date("2032-01-01T00:00:00.000Z")};
