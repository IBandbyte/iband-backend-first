...
assert.match(server,/createMovieMentorProductionAuthenticationComposition/);assert.match(server,/createMovieMentorCreatorRequestAuthority/);assert.match(server,/createMovieMentorTurnRouter/);assert.match(server,/createMovieMentorProductionInferenceExecutionComposition/);assert.match(server,/inferenceExecutionAuthority:\s*executionComposition\.authority/);assert.match(server,/executionComposition\?\.authority\?\.commitCanonicalResult/);assert.match(server,/executionComposition\?\.authority\?\.readCanonicalResult/);assert.match(server,/app\.use\("\/api\/movie-mentor",\s*router\)/);assert.doesNotMatch(server,/mountRoute\("\/api\/movie-mentor","\.\/movieMentorTurn\.js"\)/);
